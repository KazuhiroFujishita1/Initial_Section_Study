...
class Column2D:
    def __init__(self, node_i, node_j, column, direction):
        ...
        if direction == "X":
            ...
            self.x2 = node_j.x
            self.y2 = node_j.z
            self.m1 = -column.M_Sx[0]
            self.m2 = -column.M_Sx[1]
            ...
            self.x2 = node_j.y
            self.y2 = node_j.z
            self.m1 = -column.M_Sy[0]
            self.m2 = -column.M_Sy[1]
...
class Beam2D:
    def __init__(self, node_i, node_j, beam, direction):
        ...
        if direction == "X":
            ...
            self.m2 = beam.M_Sx[1]
            #self.m0 = beam.M0
            self.m0 = 1/2*(beam.M_Sx[0]+beam.M_Sx[1])
            ...
            self.m2 = beam.M_Sy[1]
            #self.m0 = beam.M0
            self.m0 = 1/2*(beam.M_Sy[0]+beam.M_Sy[1])
